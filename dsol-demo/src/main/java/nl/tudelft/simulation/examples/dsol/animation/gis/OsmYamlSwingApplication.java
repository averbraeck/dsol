...
import nl.tudelft.simulation.dsol.animation.gis.osm.OsmFileYamlParser;
 ...
 */
public class OsmYamlSwingApplication extends DsolAnimationApplication
{
    /** */
        ...
        public void constructModel() throws SimRuntimeException
        {
            ...
            try
            {
                this.gisMap = new OsmRenderable2d(getSimulator().getReplication(),
                        OsmFileYamlParser.parseMapFile(yamlUrl, osmUrl, "TU Delft"));
            }
