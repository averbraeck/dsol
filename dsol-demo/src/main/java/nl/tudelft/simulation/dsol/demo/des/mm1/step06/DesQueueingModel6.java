 ...
 */
class DesQueueingModel6 extends AbstractDsolModel<Double, DevsSimulatorInterface<Double>>
{
     ...
     */
    public DesQueueingModel6(final DevsSimulatorInterface<Double> simulator, final DistContinuous interArrivalTime,
