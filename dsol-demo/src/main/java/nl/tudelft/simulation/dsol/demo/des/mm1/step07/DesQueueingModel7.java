 ...
 */
class DesQueueingModel7 extends AbstractDsolModel<Double, DevsSimulatorInterface<Double>>
{
    ...
    /** the parameter of the exponentially distributed processing time of entities. */
     ...
     * @param lambda the parameter of the exponentially distributed interarrival time between entities
     * @param mu the parameter of the exponentially distributed processing time of entities
     */
    public DesQueueingModel7(final DevsSimulatorInterface<Double> simulator, final double lambda, final double mu)
    {
        super(simulator);
        this.lambda = lambda;
        this.mu = mu;
