...
/**
 * SimTimeFormatter for Float simulator time.
 * <p>
 ...
 */
public class FloatSimTimeFormatter extends SimTimeFormatter<Float>
{
    /**
     * Make a SimTimeFormatter for a specific simulator instance.
     * @param simulator the simulator
     */
    public FloatSimTimeFormatter(final SimulatorInterface<Float> simulator)
    {
        super(simulator);
    }
