...
/**
 * TimeDevsRealTimeAnimator is an extension of the DevsRealTimeAnimator that works with Duration and Time.
 * <p>
...
public class TimeDevsRealTimeAnimator extends DevsRealTimeAnimator<Duration> implements TimeDevsSimulatorInterface
{
    ...
    /**
     * Instantiate a TimeDevsRealTimeAnimator.
     * @param id the id of the simulator
     * @param startTime the startTime of the simulator as a Time
     */
    public TimeDevsRealTimeAnimator(final Serializable id, final Time startTime)
    {
        super(id);
