...
public interface ContextInterface extends EventProducer, Serializable
{
     ...
     * @param name the name of the object to look up; may be a compound name
     * @return the Context or Object indicated by the name
     ...
     * @param key the name of the object to look up; NOT a compound name
     * @return the Context or Object indicated by the key
     ...
     * @param name the name of the object to look up; may be a compound name
     * @return whether an object with the given name has been registered
     * @throws NamingException as a placeholder overarching exception
     ...
     * @param key the name of the object to look up; NOT compound
     ...
     * @param key the key under which the object will be stored; NOT a compound name
     * @param object the Context or Object to be stored into this Context using the given name; a null object is allowed
     * @throws NamingException when key is the empty string or when key contains "/"
     ...
     * @param oldName the (compound) name of the object to be moved to a new location
     * @param newName the (compound) name with the terminal reference indicating where the object will be stored
     ...
     * @param object the object that has changed and for which an event should be fired
     ...
     * characters.
     * @param key the key within the context of the object that has changed and for which an event should be fired
