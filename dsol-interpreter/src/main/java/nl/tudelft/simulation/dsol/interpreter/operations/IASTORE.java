...
/**
 * The IASTORE operation as defined in <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">
 ...
 */
public class IASTORE extends VoidOperation
{
    ...
    {
        int value = Primitive.toInteger(stack.pop()).intValue();
