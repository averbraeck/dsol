...
/**
 * The IFGE operation as defined in <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">
 ...
 */
public class IFGE extends JumpOperation
{
    /** OP refers to the operand code. */
    public static final int OP = 156;
     ...
     */
    public IFGE(final DataInput dataInput) throws IOException
    {
        super();
