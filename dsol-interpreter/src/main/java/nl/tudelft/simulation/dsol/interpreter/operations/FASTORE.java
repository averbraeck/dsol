...
/**
 * The FASTORE operation as defined in <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">
 ...
 */
public class FASTORE extends VoidOperation
{
    /** OP refers to the operand code. */
    public static final int OP = 81;
    ...
    {
        float value = ((Number) stack.pop()).floatValue();
