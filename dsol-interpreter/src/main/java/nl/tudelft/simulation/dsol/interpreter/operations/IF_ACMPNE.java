...
/**
 * The IF_ACMPNE operation as defined in <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">
 ...
 */
public class IF_ACMPNE extends JumpOperation
{
    /** OP refers to the operand code. */
    public static final int OP = 166;
     ...
     */
    public IF_ACMPNE(final DataInput dataInput) throws IOException
    {
        super();
