...
/**
 * The LALOAD operation as defined in <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-6.html#jvms-6.5">
 ...
 */
public class LALOAD extends VoidOperation
{
    /** OP refers to the operand code. */
    public static final int OP = 47;
    ...
    public void execute(final OperandStack stack, final Constant[] constantPool, final LocalVariable[] localVariables)
    {
        ...
        stack.push(Long.valueOf(Array.getLong(arrayref, index)));
    }
