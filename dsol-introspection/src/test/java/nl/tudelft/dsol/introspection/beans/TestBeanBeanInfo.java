...
public class TestBeanBeanInfo extends SimpleBeanInfo
{
    ...
    static
    {
        try
        {
            ...
            properties[PROPERTY_intProp] = new PropertyDescriptor("intProp", TestBean.class, "getIntProp", "setIntProp");
            ...
            properties[PROPERTY_subBean] = new PropertyDescriptor("subBean", TestBean.class, "getSubBean", "setSubBean");
    ...
    static
    {
        try
        {
            methods[METHOD_toString0] = new MethodDescriptor(
                    Class.forName("junit.nl.tudelft.dsol.introspection.beans.TestBean").getMethod("toString", new Class[] {}));
